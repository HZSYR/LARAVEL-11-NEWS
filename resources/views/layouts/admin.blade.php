            ...
            <div class="sidebar-logo">
                ...
                <div class="logo-header" data-background-color="dark">
                    <a href="{{ route('index') }}" class="logo">
                        <img src="{{ asset('admin/img/kaiadmin/logo_light.png') }}" alt="navbar brand"
            ...
            <footer class="footer">
                <div class="container-fluid d-flex justify-content-between">
                    ...
                    <div class="copyright">
                        ...
                        <span class="copyright-text">crafted with</span>
                        <i class="fa fa-heart heart text-danger pulse"></i>
                        <span class="copyright-by">by</span>
                        <a href="#" class="copyright-name">HAFIZH ASSYURA & ERIK MULYA SAPUTRA</a>
                    </div>
                    <div>
                        Distributed by
                        <a target="_blank" href="https://www.domuss.my.id/">DOMUS</a>.
                    </div>
                </div>
            </footer>
